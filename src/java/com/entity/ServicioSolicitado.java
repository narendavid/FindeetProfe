...
public class ServicioSolicitado implements Serializable {
    ...
    public ServicioSolicitado(Long id, Servicio servicio, String estado, int cantidad, Date fechaEntrega, Responsable responsable) {
        this.id = id;
    ...
    public String toString() {
        return "com.entity.ServicioSolicitado[ id=" + getId() + " ]";
    }
